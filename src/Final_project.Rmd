...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      numericInput("smoothness", "Smoothness Mean", value = 0.1, min = 0, max = 1, step = 0.01),
      numericInput("compactness", "Compactness Mean", value = 0.1, min = 0, max = 1, step = 0.01),
      numericInput("concavity", "Concavity Mean", value = 0.1, min = 0, max = 1, step = 0.01),
      numericInput("concave_points", "Concave Points Mean", value = 0.1, min = 0, max = 1, step = 0.01),
      numericInput("symmetry", "Symmetry Mean", value = 0.1, min = 0, max = 1, step = 0.01),
      numericInput("radius_se", "Radius SE", value = 0.1, min = 0, max = 5, step = 0.01),
      numericInput("fractal_dimension", "Fractal Dimension Mean", value = 0.1, min = 0, max = 1, step = 0.01),
...
#   
  observeEvent(input$predict_btn, {
    ...
    new_data <- data.frame(
      ...
      compactness_mean = as.numeric(input$compactness),
      concavity_mean = as.numeric(input$concavity),
      concave.points_mean = as.numeric(input$concave_points),
      symmetry_mean = as.numeric(input$symmetry),
  ...
  # densityplot: radius Mean by Diagnosis
  output$density_radius <- renderPlot({
  ggplot(data, aes(x = radius_mean, fill = diagnosis)) +
    geom_density(alpha = 0.5) +
    labs(
      title = "Density Plot of Radius Mean by Diagnosis",
      x = "Radius Mean",
      y = "Density"
    ) +
  ...
  # densityplot: perimeter Mean by Diagnosis
  output$density_perimeter <- renderPlot({
  ggplot(data, aes(x = perimeter_mean, fill = diagnosis)) +
    geom_density(alpha = 0.5) +
    labs(
      title = "Density Plot of perimeter Mean by Diagnosis",
      x = "perimeter Mean",
      y = "Density"
    ) +
    scale_fill_manual(values = c("B" = "green", "M" = "red")) +
  ...
  output$density_texture <- renderPlot({
  ggplot(data, aes(x = texture_mean, fill = diagnosis)) +
    geom_density(alpha = 0.5) +
    labs(
      title = "Density Plot of texture Mean by Diagnosis",
      x = "texture Mean",
      y = "Density"
    ) +
    scale_fill_manual(values = c("B" = "green", "M" = "red")) +
  ...
  # violinplot: radius Mean by Diagnosis
  output$violin_radius <- renderPlot({
  ggplot(data, aes(x = diagnosis, y = radius_mean, fill = diagnosis)) +
    geom_violin(trim = TRUE, alpha = 0.7) +
    labs(
      title = "Violin Plot of Radius Mean by Diagnosis",
      x = "Diagnosis",
      y = "Radius Mean"
    ) +
    scale_fill_manual(values = c("B" = "green", "M" = "red")) +
  ...
  # violinplot: perimeter Mean by Diagnosis
  output$violin_perimeter <- renderPlot({
  ggplot(data, aes(x = diagnosis, y = perimeter_mean, fill = diagnosis)) +
    geom_violin(trim = TRUE, alpha = 0.7) +
    labs(
      title = "Violin Plot of perimeter Mean by Diagnosis",
      x = "Diagnosis",
      y = "perimeter Mean"
    ) +
    scale_fill_manual(values = c("B" = "green", "M" = "red")) +
  ...
  output$violin_texture <- renderPlot({
  ggplot(data, aes(x = diagnosis, y = texture_mean, fill = diagnosis)) +
    geom_violin(trim = TRUE, alpha = 0.7) +
    labs(
      title = "Violin Plot of texture Mean by Diagnosis",
      x = "Diagnosis",
      y = "texture Mean"
    ) +
    scale_fill_manual(values = c("B" = "green", "M" = "red")) +
  ...
  ggplot(data, aes(x = diagnosis, y = area_mean, fill = diagnosis)) +
    geom_violin(trim = TRUE, alpha = 0.7) +
    labs(
      title = "Violin Plot of area Mean by Diagnosis",
      x = "Diagnosis",
      y = "area Mean"
    ) +
    scale_fill_manual(values = c("B" = "green", "M" = "red")) +
  ...
  output$faceted_density_plot <- renderPlot({
  ggplot(data, aes(x = radius_mean, fill = diagnosis)) +
    geom_density(alpha = 0.5) +
    labs(
      title = "Faceted Density Plot of Radius Mean by Diagnosis",
      x = "Radius Mean",
      y = "Density"
    ) +
